...
#ifndef ADAPTERSAPPKIT_SWIFT_H
#define ADAPTERSAPPKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdaptersAppKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Pure-Swift window delegate that consumes a <code>TopologySnapshot</code> published by the
/// daemon and applies layout policy when the hosting window crosses displays or
/// the backing properties change.
SWIFT_CLASS("_TtC14AdaptersAppKit23WorkspaceWindowDelegate")
@interface WorkspaceWindowDelegate : NSObject <NSWindowDelegate>
